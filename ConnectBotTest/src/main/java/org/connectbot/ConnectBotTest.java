package org.connectbot.appchecktest;
...
public class ConnectBotTest extends ActivityInstrumentationTestCase2<Activity>{

    private static final String LAUNCHER_ACTIVITY_CLASSNAME = "org.connectbot.HostListActivity";
            ...
            try {
                do {
                    ...
                    if(num > 0){
                        ...
                        Log.d("TestCase", "doSystemEvents");
                        mDevice.setOrientationRight();
                        mDevice.setOrientationNatural();
	                    Log.d("TestCase", "endDoSystemEvents");
	                    while(num > 0){
    ...
    public void test() throws Exception{
    	...
    	Intents.init();
		onView(withId("org.connectbot:id/front_quickconnect")).perform(clearText(), 
            typeTextIntoFocusedView("nikle@133.133.133.38"));

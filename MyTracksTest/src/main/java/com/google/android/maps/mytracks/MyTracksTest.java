package com.google.android.maps.mytracks.appchecktest;
...
public class MyTracksTest extends ActivityInstrumentationTestCase2<Activity>{

    private static final String LAUNCHER_ACTIVITY_CLASSNAME = "com.google.android.apps.mytracks.MyTracks";
    ...
    public void test() throws Exception{
        ...
        mDevice.pressMenu();
        onView(withText("Record track")).perform(click());
        mDevice.pressMenu();
        onView(withText("Stop recording")).perform(click());
